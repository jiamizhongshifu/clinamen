    ...
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          float outerDirection = smoothstep(-0.08, 0.32, radialOut);
          ...
          float exteriorWallBase = outerWall * (1.0 - smoothstep(0.28, 0.96, h));
          float exteriorWaterline = outerWall * (1.0 - smoothstep(0.54, 0.86, h));
          vec3 exteriorWallCol = vec3(0.28, 0.49, 0.58);
          vec3 exteriorLowerCol = vec3(0.06, 0.36, 0.52);
          col = mix(col, exteriorWallCol, clamp(exteriorWallBase * 0.88, 0.0, 0.88));
          col = mix(col, exteriorLowerCol, clamp(exteriorWaterline * 0.44 + lowerWall * 0.54, 0.0, 0.70));
